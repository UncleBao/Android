...
import com.sd.pos.camera.CameraManager;
import com.sd.pos.R;
...
public final class CaptureActivity extends Activity implements
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		intent.putExtra(Result_Key, rawResult.getText());
		setResult(Activity.RESULT_OK, intent);
		// 通用
		Result_String = rawResult.getText();
		Result_Bitmap = barcode;
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		try {
			...
			Toast.makeText(this, "Unexpected error initializing camera",
					Toast.LENGTH_LONG);
